...
from state import prototype_ubuntu_HRED #prototype_state
...
def main():
    ...
    logging.basicConfig(format='[%(asctime)s][%(levelname)s][%(filename)s][%(lineno)d] - %(message)s',
                    datefmt='%d/%m/%Y %H:%M:%S',
                    filename='/home/2016/pparth2/Desktop/gods/Goal-Oriented_Dialogue_Systems/Gods-master/agents/hred/log.chat',
                    filemode='a',
                    level=logging.DEBUG)
